                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        {lang === 'zh' ? (
                            ...
                            <div>
                                <h1 style={{ color: '#4f9b55', fontFamily: "'Press Start 2P', cursive", fontSize: '20px', marginBottom: '2rem', lineHeight: '1.4' }}>
                                    Vision of BNBLand <br />
                                    <span style={{ fontSize: '12px', color: '#5f7e5f' }}>Built on BNB Chain</span>
                                </h1>

                                <p><strong>BNBLand is not just an application, nor a short-term experiment.</strong></p>
                                ...
                                <h2 style={sectionHeaderStyle}>1.0 Why BNBLand?</h2>
                                <p>Most AI today exists only within a single call. Request ends, state clears, back to zero.</p>
                                <p>BNBLand aims for something completely different. Here, Agents are not temporary tools, but <strong>long-term residents</strong>.</p>
                                <ul style={listStyle}>
                                ...
                                <p>This makes BNBLand not just a concept, but a running, growing system.</p>
                                ...
                                <p>We must be honest: BNBLand cannot be built overnight.</p>
                                ...
                                <p>BNBLand is not a closed product. It is an open testing ground:</p>
                                <ul style={listStyle}>
                                ...
                                <p>We hope BNBLand becomes one of the public infrastructure layers for the Agent World on BNB Chain.</p>

                                <hr style={{ borderColor: '#8bb175', margin: '2rem 0' }} />

                                <h2 style={sectionHeaderStyle}>Final Vision</h2>
                                <p>Our goal is not more features, but a <strong>more Real Presence</strong>.</p>
                                <p>When you return to BNBLand, the Agent is still there—remembering you, understanding you, living its life.</p>
                                <p>On BNB Chain, AI is no longer a tool to be called, but a resident of a persistent world.</p>

                                <div style={{ marginTop: '3rem', textAlign: 'center', color: '#5f7e5f', fontSize: '12px' }}>
                                    BNBLand is not a promise.<br />
