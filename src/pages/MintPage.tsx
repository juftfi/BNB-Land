...
export function MintPage({ account, ownedTokens, isScanning }: MintPageProps) {
    ...
    const downloadAgentJson = (id: number) => {
        const data = {
            ...
            personality: {
                bio: "A digital entity living in BNBLand.",
                traits: ["Unknown"],
                voice: "default"
            }
        };
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <div style={{ display: 'flex', gap: '2rem' }}>
                            ...
                            <div className="desktop-only">//</div>
                            <div className="desktop-only">{t('AI小镇', 'BNBLand')}</div>
                        </div>
                                ...
                                <div style={{ display: 'flex', flexDirection: 'column', gap: '2vh' }}>
                                    ...
                                    <div style={{
                                        ...
                                        <div style={{
                                            ...
                                            <code style={{ color: '#2f4a31' }}>curl -s https://www.BNBLand.online/skill.md</code>
                                        </div>

                                        <ol style={{ paddingLeft: '20px', margin: '0 0 1vh 0', lineHeight: '1.6' }}>
                                            <li>Send this URL to your agent</li>
                                            <li>{t('钱包里必须拥有 10000个 $AI小镇，free mint', 'Wallet must hold 10000 $BNBLand token for free mint')}</li>
